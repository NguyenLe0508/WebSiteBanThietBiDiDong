    ...
    public partial class WebForm5 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (id != null)
            {
                ...
                ListViewChitietPhone.DataSource = sp;
                ListViewChitietPhone.DataBind();
                ...
                {
                    Response.Cookies["Seen"].Value = $"{id},";
                    Response.Cookies["Seen"].Expires = DateTime.Now.AddDays(14);
                ...
                else
                {
                    ...
                    if(trung == 0)
                    {
                        Response.Cookies["Seen"].Value = Request.Cookies["Seen"].Value + $"{id},";
                        Response.Cookies["Seen"].Expires = DateTime.Now.AddDays(14);
                    }    
                }
            }
        ...
        protected void Unnamed_ServerClick(object sender, EventArgs e)
        {
            ...
            //List<product> danhsach = (List<product>)Application["danhsachsanpham"];
