<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="signup.aspx.cs" Inherits="BTL_asp.WebForm3" %>
...
<body>
    <form id="form1" runat="server" method="post" onsubmit="return fromSubmit_signup()" >
        <div class="wrapper">
            <div class="main">
                <div class="content">
                    <div class="login-logo">
                        <div class="logoshop">
                            <a href="index.aspx">
                                <img class="logo" src="assets/images/logo/logo 364364.png" alt="Ảnh lỗi" />
                            </a>
                        </div>
                        <div class="logochu">
                            <img class="logochu" src="assets/images/logo/logochutrang.png" alt="Ảnh lỗi" />
                        </div>
                        <div class="PR">
                        ...
                        <div class="login">
                            <div class="box">
                                ...
                                <div class="username">
                                    ...
                                    <div class="phone">
                                        <input type="text" name="phone" id="phone" placeholder="Nhập số điện thoại" value="" />
                                        <div id="error_phone" runat="server"></div>
                                    </div>
                                    <div class="email">
                                        <input type="text" name="email" id="email" placeholder="Nhập email" value="" onkeyup="validateEmail()" />
                                    ...
                                    <div class="re-password">
                                        <input type="text" name="repassword" id="re-password" placeholder="Xác nhận mật khẩu" value="" />
                                        <div id="result" runat="server"></div>
                                    </div>
                                </div>
                                <div class="login-click">
                                    <asp:Button ID="signup" runat="server" Text="ĐĂNG KÝ" OnClick="signup_Click" />
                                </div>
                                <div class="or">
                                    <div class="col"></div>
                                ...
                                <div class="sign-in">
                                    <span>Nếu bạn đã có tài khoản? <a href="login.aspx">Đăng Nhập</a></span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/javascript" src="assets/js/script-signup.js"></script>
</body>
</html>
