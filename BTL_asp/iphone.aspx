<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="iphone.aspx.cs" Inherits="BTL_asp.WebForm8" %>
...
<head runat="server">
    ...
    <title>iPhone | Thiết bị di động - Nơi cung cấp điện thoại, laptop, phụ kiện chất lượng, giá tốt</title>
            ...
            <div class="main">
                ...
                <div class="main-content">
                    <div class="title">
                        ...
                        <i class="fas fa-chevron-right"></i>
                        <div class="phone-text">iPhone</div>
                    </div>
                    <div class="container">
                        <div class="container-left">
                            <div class="classify loai-dt"> 
                                ...
                                <div class="classify-text">
                                    <p class="first"><a class="All" href="phone.aspx">Tất cả</a></p>
                                    <p><a href="iphone.aspx">Android</a></p>
                                    <p class="finnish"><a href="iphone.aspx">iPhone (iOS)</a></p>
                                </div>
                            </div>
                            <div class="classify RAM"> 
                                ...
                                <div class="classify-text">
                                    <p class="first"><a class="All" href="phone.aspx">Tất cả</a></p>
                                    <p><a href="iphone.aspx">4GB - 6GB</a></p>
                                    <p><a href="iphone.aspx">8GB Trở lên</a></p>
                                    <p class="finnish"><a href="iphone.aspx">Dưới 4GB</a></p>
                                </div>
                            </div>  
                            <div class="classify memory"> 
                                ...
                                <div class="classify-text">
                                    <p class="first"><a class="All" href="phone.aspx">Tất cả</a></p>
                                    <p><a href="iphone.aspx">128GB và 256GB</a></p>
                                    <p><a href="iphone.aspx">32GB và 64GB</a></p>
                                    <p><a href="iphone.aspx">Dưới 32GB</a></p>
                                    <p class="finnish"><a href="iphone.aspx">Trên 512GB</a></p>
                                </div>
                            </div>  
                        </div>
                        <div class="container-right">
                            <div class="title-text">
                                <p>Mua điện thoại giá rẻ</p>
                            </div>
                            <div class="right-title">
                                <div class="title-object">
                                    <a href="iphone.aspx"><div class="box-object">
                                        <p>iPhone</p>
                                    </div></a>
                                    <a href="iphone.aspx"><div class="box-object">
                                        <p>Realme</p>
                                    ...
                                    <a href="phone.aspx"><div class="box-object">
                                        <p>Điện thoại nổi bật</p>
                                    </div></a>
                                </div>
                            </div>
                            <div class="object">
                                <asp:ListView ID="ListViewiPhone" runat="server">
                                        <ItemTemplate>
                                                <div class="col col1">
                                                    <div class="img-deal">
